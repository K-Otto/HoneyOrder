Ext.define('_App.view.medicine.UpdateMedicine', {
    extend: 'Ext.Panel',
    requires: [
    ...
    updateMedicine: function (medicineId) {
        ...
        Ext.Viewport.setActiveItem(new _App.view.medicine.UpdateMedicineForm());
